  ...
  return (
    ...
    >
      <div className={`flex items-center w-full ${classButton ? classButton : title ? "justify-start" : "item-center flex-grow justify-center ml-2 mr-2 gap-2"}`}>
        ...
        {titlePosition === "before" && <Title title={title} className={classTitle} fontBold={fontBold} fontMedium={fontMedium} xxxl={xxxl} xxl={xxl} xl={xl} large={large} medium={medium} small={small} nowrap={nowrap} titleCustom={titleCustom} />}
        ...
        <div className={`${iconPosition !== "right" ? "" : "flex-1"}`}>
          {srcPosition !== "before" && src && <Image className={classImg} src={src} srcDark={srcDark} srcSet={srcSet} srcSetDark={srcSetDark} alt={alt} />}
          {titlePosition !== "before" && title && <Title title={title} className={classTitle} fontBold={fontBold} fontMedium={fontMedium} xxxl={xxxl} xxl={xxl} xl={xl} large={large} medium={medium} small={small} nowrap={nowrap} titleCustom={titleCustom} />}
        </div>
