...
function Title({ title, small, medium, large, xl, xxl, xxxl, extraLarge4, extraLarge5, extraLarge6, extraLarge7, extraLarge8, extraLarge9, extraLarge10, nowrap = true, fontBold, fontMedium, className, ...props }) {
  return (
    <span
